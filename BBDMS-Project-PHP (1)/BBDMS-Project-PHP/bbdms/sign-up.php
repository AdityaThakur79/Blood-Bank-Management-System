...
<body>
	...
	<!-- about -->
		 ...
		 <div class="signup-container"> 
			<div class="chota-container"> 
		  <h5 class="title2">Register Now</h5>
...
?>
                                ...
                                <button type="submit" class="btn btn-primary submit mb-4 signup-button" name="submit">Register</button>
