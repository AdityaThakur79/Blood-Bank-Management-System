...
<body>
	...
	<div class="login-page bk-img" style="background: linear-gradient(rgba(0, 0, 0, 0.6),red);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">BBMS Forgot Password</h1>
