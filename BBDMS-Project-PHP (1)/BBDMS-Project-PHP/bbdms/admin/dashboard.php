...
?>
													...
													<div class="stat-panel-title text-uppercase">Blood Requests received</div>
												</div>
											</div>
			...
			<div class="col-md-4">
										<div class="panel panel-danger">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
												<?php 
$sql6 ="SELECT v_id  from tblvolunteer ";
$query6 = $dbh -> prepare($sql6);;
$query6->execute();
$results6=$query6->fetchAll(PDO::FETCH_OBJ);
$totalvolunteers=$query6->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalvolunteers);?></div>
													<div class="stat-panel-title text-uppercase">Volunteers Registeration</div>
												</div>
											</div>
											<a href="volunteerreg.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
