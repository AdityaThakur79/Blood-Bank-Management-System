...
(8, 'Devendra Pal', 'devendrapal46738@gmail.com', '9881024550', 'hello', '2023-04-08 06:45:34', NULL),
(9, 'Devendra Pal', 'devendrapal46738@gmail.com', '9881024550', 'hello', '2023-04-08 06:49:26', NULL),
(10, 'asds', 'devendrapal46738@gmail.com', '999999999', 'why', '2023-04-08 07:20:55', NULL);
...
CREATE TABLE `tblvolunteer` (
  ...
  `ContactNumber` int(33) NOT NULL,
  `City` varchar(255) NOT NULL,
  `District` varchar(255) NOT NULL,
  `PostingDate` timestamp(3) NOT NULL DEFAULT current_timestamp(3) ON UPDATE current_timestamp(3),
...
INSERT INTO `tblvolunteer` (`v_id`, `name`, `EmailId`, `ContactNumber`, `City`, `District`, `PostingDate`, `Status`) VALUES
(1, 'Devendra Pal', 'devendrapal46738@gmail.com', 2147483647, 'Bhiwandi', 'thane', '2023-04-08 07:26:58.193', 0),
(2, 'Devendra Pal', 'devendrapal46738@gmail.com', 2147483647, 'Bhiwandi', 'thane', '2023-04-08 07:28:16.911', 0);
...
--
ALTER TABLE `tblvolunteer`
  MODIFY `v_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
